...
public class JwtProvider {
    ...
    public String generateAccessToken(@NonNull User user) {
        ...
        final Instant accessExpirationInstant = now.plusMinutes(5).atZone(ZoneId.systemDefault()).toInstant(); //время жизни токена
    ...
    // аналогично access token, но без claims и с большим сроком
